...
public class MorseCodeConverterTestPublic {
	...
	@Test
	public void testConvertMorseStringToEnglish() {	
		
		String converter1 = MorseCodeConverter.convertToEnglish("- .-. . . ... / .- .-. . / .... .- .-. -..");
		assertEquals("trees are hard", converter1);
	...
	@Test
	public void testConvertMorseFileToEnglish() {	

		File file = new File("src/Times.txt"); 
		try {
			
			assertEquals("its peanut butter time", MorseCodeConverter.convertToEnglish(file));
		} 
